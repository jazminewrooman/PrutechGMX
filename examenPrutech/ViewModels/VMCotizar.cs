	...
	@"(?(\[)(\[(\d{1,3}\.){3}\d{1,3}\])|(([0-9a-z][-\w]*[0-9a-z]*\.)+[a-z0-9][\-a-z0-9]{0,22}[a-z0-9]))$";
        ...
        public void GuardarBD()
        {
            ...
            try
            {
                ...
                if (PolizaGenerada != null)
                    int.TryParse(PolizaGenerada.Movimiento, out mov);
                string statustrans = "";
                if (DatosBank == null)
                    statustrans = "banco";
                if (DatosFiscales != null)
                {
                    rfcfiscal = DatosFiscales.RFC;
                    domfiscal = $"{DatosFiscales.Direccion} CP: {DatosFiscales.CP} Colonia: {DatosFiscales.ColoniaStr} Estado: {DatosFiscales.EstadoStr} Municipio: {DatosFiscales.MunicipioStr}";
                    if (DatosFiscales.Persona == TipoPersona.Fisica)
                        nombrefiscal = $"{DatosFiscales.Nombre} {DatosFiscales.APaterno} {DatosFiscales.AMaterno}";
                    if (DatosFiscales.Persona == TipoPersona.Moral)
                        nombrefiscal = DatosFiscales.APaterno;
                }
        ...
        public void MandarPagar()
        {
            ...
            try
            {
                ...
                StrTransBanco = "<CENTEROFPAYMENTS xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><reference>0817100066191413526900</reference><response>approved</response><foliocpagos>461555306</foliocpagos><auth>012256</auth><cd_response>00</cd_response><cd_error /><nb_error /><nb_company>GMX SEGUROS</nb_company><nb_merchant>7203635 GMX</nb_merchant><nb_street>INSURGENTES SUR 1605 COL. SAN JOSE INSURGENTES, DF</nb_street><cc_type>CREDITO/BANCO INVEX/Visa</cc_type><tp_operation>VENTA</tp_operation><cc_name>LUIS AZUL CONTRERAS MORENO</cc_name><cc_number>5551</cc_number><cc_expmonth>04</cc_expmonth><cc_expyear>22</cc_expyear><amount>9312.48</amount><voucher></voucher><tokenb5 /><tokenb6 /><voucher_comercio></voucher_comercio><voucher_cliente></voucher_cliente><friendly_response>Aprobado</friendly_response><emv_key_date /><icc_csn /><icc_atc /><icc_arpc /><icc_issuer_script /><authorized_amount /><account_balance_1 /></CENTEROFPAYMENTS>";
        ...
        private string strtransbanco;
        public string StrTransBanco
		{
			get => strtransbanco;
			set
			{
				if (strtransbanco != value)
				{
					strtransbanco = value;
					OnPropertyChanged("StrTransBanco");
				}
			}
		}
