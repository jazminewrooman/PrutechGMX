				...
				Text = "<table cellpadding='5' class='ctable'>" +
                    ...
                    "<td class='ctd' style='width: 60%;'><p>Límite Máximo de Responsabilidad Único y Máximo en el agregado anual incluyendo Gastos de Defensa Juridica: " + sumaaseg + "</p></td>" +
								   ...
								   "<tr class='ctr'> " +
									   ...
									   "<p>También queda incluida dentro de esta última la responsabilidad por el uso de mecanismos, instrumentos, aparatos o substancias peligrosas por sí mismos y que dan lugar a responsabilidad civil.</p><br/>" +
									   ...
									   "<p style='text-align: justify;'>No serán materia de cobertura las indemnizaciones adicionales a las que sea condenado el Asegurado por las agravantes con las cuales haya actuado para la realización del daño, incluso cuando dichas agravantes sean considerados como parte de una indemnización identificada bajo el rubro o el concepto de daño moral.</p><br/>" +
